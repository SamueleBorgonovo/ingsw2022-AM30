...
/**
 * Class used to move mother nature up to two additional islands than indicated on
 * the assistant card chosen by the player
 */
public class Effect4 extends Effect{
    ...
    /**
     * Method used to move mother nature up to two more islands than the value
     * indicated on the assistant card chosen by the player
